...
function Cart() {
  ...
  const handleRentAll = () => {
    ...
    if (!isAuthenticated()) {
      alert("Vous devez être connecté pour louer des films.");
    ...
    if (result.success) {
      ...
      // Affichage de la page des locations
      navigate('/my-rentals');
    }
  };
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800 sticky top-24">
              ...
              <button 
                ...
                className="w-full mb-3 px-4 py-3 bg-red-600 hover:bg-red-700 rounded font-bold transition"
              >
              ...
              <button
                onClick={clearCart}
                className="w-full px-4 py-2 border border-gray-700 rounded hover:bg-gray-800 transition text-sm"
              >
                Vider le panier
              </button>
            </div>
